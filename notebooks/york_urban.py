...
import vp_toolbox.vp.geom_tools as geom_tools
import vp_toolbox.notebooks.dataset as dataset
import vp_toolbox.notebooks.print_progress as print_progress
...
def load_dataset(dataset_path, show_progress_bar=True):
    ...
    #     entries = print_progress.print_progress(entries)
